...
from Dropout_neural_network import *
from f_load_data import *
import argparse
import matplotlib.pyplot as plt

parser = argparse.ArgumentParser(description='')
parser.add_argument('--layer_dim', dest='layer_dim', type=list, default=[1440, 500, 500, 17], help='no of layers with neurons')
parser.add_argument('--activations', dest='activations', type=list, default=[None, 'lrelu', 'lrelu','softmax'], help='activation function')
parser.add_argument('--optimizer', dest='optimizer', default='adam', help='sgd, momentum, adam')
parser.add_argument('--epochs', dest='epochs', type=int, default=40, help='epochs')
...
parser.add_argument('--keep_prob', dest='keep_prob', type=int, default=0.9, help='keep_prob')
